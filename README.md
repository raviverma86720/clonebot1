...
<details>
  <summary><b>Deploy</b></summary>
    <p align="left">
        ...
        2. Change the URL of 'repository' parameter in <a href="https://github.com/raviverma86720/clonebot1/blob/master/app.json#L7"> app.json</a> to your fork URL.<br>
        3. Change the <a href="https://github.com/raviverma86720/clonebot1/blob/master/README.md?plain=1#L33"> Deploy button URL</a> to your fork URL.<br>
        4. Finally, deploy it from your own fork.<br><br>
      <a href="https://heroku.com/deploy?template=https://github.com/raviverma86720/clonebot1" target="_blank">
